...
class Block(nn.Module):
    ...
    def forward(self, x, h, w):
        ...
        #x = x + self.drop_path(self.mlp(self.norm2(x))) # old implementation
        return x
...
class LocalConvolutionalVisionTransformer(nn.Module):
    def __init__(self,
                 in_chans=3,
                 num_classes=1000,
                 act_layer=nn.GELU,
...
def get_cls_model(config, **kwargs):
    ...
    msvit = LocalConvolutionalVisionTransformer(
        in_chans=3,
